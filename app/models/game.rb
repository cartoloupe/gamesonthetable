class Game < ActiveRecord::Base
  ...
  # The following code broadcasts to a channel using the same mechanism as in
  # move.rb. See https://github.com/websocket-rails/websocket-rails/wiki/Working-with-Channels
  after_save :publish_reload_games
  after_destroy :publish_reload_games
